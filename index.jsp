<%-- 
    Document   : index
    Created on : 18 Jul, 2018, 9:07:59 PM
    Author     : shivamkd
--%>
                            ...
                            <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li>
                                            <a class="page-scroll" href="#blog">Register / Login</a>
                                        </li>
                                        <li>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="slider-content">
                                    ...
                                    <div class="layer-1-1 hidden-xs wow slideInDown" data-wow-duration="2s" data-wow-delay=".2s">
                                        <h2 class="title1">Trendings </h2>
                                    </div>
                                     -->
                                    <!-- layer 2 -->
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            Anjane se safar ki anjani si baat hai..
                                           
                                        </p>
                                    </div>
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".5s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            
                                            Ye unse meri pehli mulakat hai..
                                    ...
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay="1s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            ...
                                            Dharkan tez kuch khas jazbaat hai..
                                            
                                        </p>
                                    </div>
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay="1.5s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="slider-content text-center">
                                    ...
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".1s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            Jo khula na ho kavi wo kitab kis kam ka,
                                    ...
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay=".5s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            ...
                                            Jo ek kasti na duba sake, wo sailaab kis kam ka..
                                    ...
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay="1s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            ...
                                            Yun to bagiche ke us gulzar ki tareef bahut hoti hai,
                                        </p>
                                    </div>
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay="1.5s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                           
                                            Jo chua hi na ho apke hathon ne, wo <i>Gulaab</i> kis kaam ka...
                                        </p>
                                    </div>
                                    <!-- layer 3 
                                    <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                ...
                                <div class="slider-content">
                                    ...
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay="1s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                            ...
                                            Ho samraaj kitna bhi bada,
                                        </p>
                                    </div>
                                    <div class="layer-1-2 wow slideInUp" data-wow-duration="2s" data-wow-delay="1.5s">
                                        <p class="title2" style="font-family: cursive;font-size: 24px;color: whitesmoke">
                                           
                                            Kaafi, bas ek chingaari hai...
                                        </p>
                                    </div>
                                    <!-- layer 3 
                                    <div class="layer-1-3 hidden-xs wow slideInUp" data-wow-duration="2s" data-wow-delay=".2s">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="well-left">
                            <div class="single-well" style="padding-left: 20%">
                                <a href="#">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="well-middle">
                            <div class="single-well">
                                ...
                                <p>
                                    Here we encourage author to showcase their writing on a global platform where he has
                                    enormous number of audience to appreciate them.
                                </p>
                                <ul>
                                    <li>
                                        <i class="fa fa-check"></i> Writing
                                    </li>
                                    <li>
                    ...
                    <div class="team-top">
                        ...
                        <div class="col-md-4 col-sm-3 col-xs-12">
                            <div class="single-team-member">
                                <div class="team-img">
                                    <a href="#">
                                        <img src="img/team/Dipti.jpg" alt="" >
                                    </a>
                        ...
                        <div class="col-md-4 col-sm-3 col-xs-12">
                            <div class="single-team-member">
                                <div class="team-img">
                                    <a href="#">
                                        <img src="img/team/Sruti.jpg" alt="Sruti">
                                    </a>
                                    <div class="team-social-icon text-center">
                                        <ul>
                                            <li>
                        ...
                        <div class="col-md-4 col-sm-3 col-xs-12">
                            <div class="single-team-member">
                                <div class="team-img">
                                    <a href="#">
                                        <img src="img/team/Shivam.jpg" alt="Shivam">
                                    </a>
                                    <div class="team-social-icon text-center">
                                        <ul>
                                            <li>
            ...
            <div class="work-us">
                ...
                <div class="work-right-text text-center">
                    ...
                    <form action="#" method="post">
                        <div class="row">
                            <div class="col-md-3">
                                <p style="color: whitesmoke">Name</p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row" style="padding-top: 2px">
                            <div class="col-md-3">
                                <p style="color: whitesmoke">Password</p>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright text-center">
                                <p>
                                    &copy; Copyright <strong>Siyahi</strong>. All Rights Reserved
                                </p>
                            </div>
                            <div class="credits">
                                <!--
